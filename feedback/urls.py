...
urlpatterns = [
    ...
    path('admin_files_read/<int:id>',views.admin_files_read,name="admin_files_read"),
    ...
    path('d_admin_files_read/<int:id>',views.d_admin_files_read,name="d_admin_files_read"),
    path('d_admin_update',views.d_admin_update,name="d_admin_update"),

]

"""
 ---> department_admin/feedback_status sil
  ...
  admin_department.html sill!!!
     path('aktif_pasif_update/<int:id>',views.aktif_pasif_update,name="aktif_pasif_update"), ---> aktif_pasif_update.html sil
"""