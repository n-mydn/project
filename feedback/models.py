...
class Country(models.Model):
    name = models.CharField(max_length=27,verbose_name="name",default="Türkiye",choices=country_choices)
    def __str__(self):
        return self.name

class City(models.Model):
    IdCountry = models.ForeignKey(Country, on_delete=models.CASCADE, verbose_name="country")
    name = models.CharField(max_length=27,verbose_name="city",choices=city_choices)
    def __str__(self):
        return self.name
...
class Department(models.Model):
    ...
    name = models.CharField(max_length=50,verbose_name="department_name",choices=dprt_choice)
    status = models.CharField(max_length=6,verbose_name="department_status",choices=status_choices)
    def __str__(self):
        return self.name

class FeedbackType(models.Model):
    idcompany= models.ForeignKey(Company,on_delete=models.CASCADE,verbose_name="f_type_company")
    name = models.CharField(max_length=8,verbose_name="f_type_name",choices=type_choice)
    status = models.CharField(max_length=6,verbose_name="f_type_status",choices=status_choices)
    def __str__(self):
        return self.name
...
class FeedbackReason(models.Model):
    ...
    name = models.CharField(max_length=35,verbose_name="f_reason_name",choices=reason_choice)
    status = models.CharField(max_length=6,verbose_name="f_reason_status",choices=status_choices)
    def __str__(self):
        return self.name
...
class FeedbackSource(models.Model):
    ...
    name = models.CharField(max_length=35,verbose_name="f_source_name",choices=source_choice)
    status = models.CharField(max_length=6,verbose_name="f_source_status",choices=status_choices)
    def __str__(self):
        return self.name

class FeedbackPersonel(models.Model):
    idcompany= models.ForeignKey(Company,on_delete=models.CASCADE,verbose_name="f_personel_company")
    name = models.CharField(max_length=35,verbose_name="f_personel_name",choices=personel_choice)
    def __str__(self):
        return self.name
...
class FeedbackStatus(models.Model):
    ...
    name = models.CharField(max_length=7,verbose_name="f_status_name",choices=f_status_choice)
...
class Feedback(models.Model):
    ...
    LastSolveDate = models.DateTimeField(null=True,verbose_name="Talep ve Şikayetin Yanıtı İçin Gerekli Gün(Ör: ../../.... 17:40)")
    ...
    class Meta:
        ordering = ["-FeedbackOpenDate","-IdFeedbackPriorityLevel"]
...
class FeedbackDepartment(models.Model):
    IdFeedbackUser = models.ForeignKey(FeedbackUser,verbose_name="f_id",on_delete=models.CASCADE)
    IdDepartment = models.ForeignKey(Department,on_delete=models.CASCADE,verbose_name="Talep-Şikayet Departmanı",default=1)
    FeedbackStatus = models.ForeignKey(FeedbackStatus,verbose_name="Talep-Şikayet Durumu",on_delete=models.CASCADE)
    IdFeedbackPriorityLevel = models.ForeignKey(FeedbackPriorityLevel,on_delete=models.CASCADE,verbose_name="Talep-Şikayet Öncelik Seviyesi")
    FeedbackClosedDate= models.DateTimeField(auto_now_add=True,verbose_name="Talep-Şikayet Son İşlem Saati")
    LastSolveDate = models.CharField(max_length=100,default="",verbose_name="Talep ve Şikayetin Yanıtı İçin Gerekli Zaman(Gün)")
    DurationTime = models.CharField(max_length=100,verbose_name="Geçen Süre",blank=True)
"""